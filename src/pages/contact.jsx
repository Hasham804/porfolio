        ...
        <Layout className='pt-16'>
          ...
          <div className='w-full max-w-3xl px-4 mx-auto'>
            <form onSubmit={handleSubmit}>
              ...
              <button
                type='submit'
                className='border border-dark bg-dark dark:bg-primaryDark dark:border-primaryDark shadow-lg shadow-dark/50 dark:shadow-primaryDark rounded-lg mt-6 w-full p-2 text-light text-2xl font-bold flex items-center justify-center transform transition-transform duration-300 ease-in-out active:scale-95'
